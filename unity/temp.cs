...
public class Matcher
{
    ...
    List<int> Match()
    {
        ...
        int object_index = 0, missed = 0, matched = 0;
        Debug.Log(objects.Count);
        if (object_index >= objects.Count)
        {
            Debug.Log(object_index);
            Debug.Log($"Min Time: {objects[object_index].Time[0]},  Max Time: {objects[object_index].Time[1]}");
        }
    ...
    List<Constructs> createList()
    {
        ...
        //Debug.Log($"Reading data: {line_data}");
        return line_data;
    }
}
...
public class Scorer //: MonoBehaviour
{
    ...
    // Update is called once per frame
    public void update() //added public
    {
        //Debug.Log("In Score update");
        match.update();
